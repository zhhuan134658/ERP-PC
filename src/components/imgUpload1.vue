<template>
  <div class="imgUpload" id="impuploadcopy">
    <div id="container">
      <a id="selectfiles" href="javascript:void(0);" class="btn">
        <span style="color: black">上传公司logo</span>
        <!-- <div class="avatar-uploader"> -->
        <!-- <img
                        v-if="licenceImg.length > 0"
                        :src="licenceImg[0]"
                        class="avatar"
                    />
            ...
            <li id="arr_li" v-for="(item, index) in licenceImg">
                <div class="tukuang">
                    <img
                        @click="lookimg(item)"
                        class="imgge"
                        style="width: 220px; height: 70px; float: left"
                        :src="item"
                        alt="图片"
                    />
