            ...
            <div v-if="viewPage">
              ...
              >
                ...
                <el-collapse v-model="activeNames" accordion>
                  <el-collapse-item
                    :title="'\xa0\xa0\xa0\xa0\xa0' + item.name"
                    :name="index + 1"
                    ...
                    >
                      <div class="acrbHeader">
                        <el-checkbox
                          ...
                          :key="liindex"
                          @change="
                            handleCheckAllChange($event, litem, liindex, index)
                          "
                          >{{ litem.name }}11</el-checkbox
                        >
                      </div>
                      <div class="acrbFooter acf1">
                        <el-checkbox
                          v-for="(ilist, lindex) in litem.content"
                          :label="ilist.id"
                          :disabled="isDisa"
                          v-model="ilist.status"
                          true-label="1"
                          false-label="2"
                          :key="lindex"
                          @change="
