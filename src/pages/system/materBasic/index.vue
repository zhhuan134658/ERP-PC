...
<template>
  <div id="materialBasic">
    <div class="main">
      ...
      >
        <el-tab-pane label="物资名称" name="first">
          <div class="content">
            <div class="header">
        ...
        <el-tab-pane label="物资类型" name="third">
          <div class="content">
            <div class="page-two">
              <div class="actions">
                <div>
              ...
              <div class="basicCreate" style="padding: 0px 20px">
                ...
                >
                  ...
                  >
                    ...
                    <el-table-column prop="e_name" label="仓库">
                    </el-table-column>
                    <el-table-column label="操作" width="100" align="left">
                      <template slot-scope="scope">
                        ...
                        <div>
                          <el-popconfirm
                            title="确定删除吗？"
                            @confirm="newdeleteType(scope.row)"
                          >
                            <el-button
                              type="danger"
                              slot="reference"
            ...
            <el-tabs v-model="activeNewName" type="border-card">
              <el-tab-pane label="基本信息" name="basic">
                <div class="dBasicInfo">
                  ...
                  <el-form-item label="物资类型：" class="dbasicList upOrg">
                    <el-button @click="selectAddCorp" plain style="width: 100%">
                      <span>{{ addUserForm.type_name }}</span>
                  ...
                  <el-form-item label="单位" prop="unit">
                    <el-input
                      placeholder="请输入单位"
                      v-model="addUserForm.unit"
                      maxlength="40"
                    ></el-input>
                  </el-form-item>
                  <el-form-item label="规格型号" prop="size" class="dbasicList">
                    <el-input
                      placeholder="请输入规格型号"
                      v-model="addUserForm.size"
                      maxlength="40"
                    ></el-input>
                  </el-form-item>
                  ...
                  <el-form-item label="颜色" prop="color">
                    <el-input
                      placeholder="请输入颜色"
                      v-model="addUserForm.color"
                      maxlength="10"
                    ></el-input>
                  </el-form-item>

                  <el-form-item label="品牌" prop="brand" class="dbasicList">
                    <el-input
                      placeholder="请输入品牌"
                  ...
                  >
                    <el-input
                      placeholder="请输入档次级别"
                      v-model="addUserForm.grade_level"
                      maxlength="10"
                    ></el-input>
                  </el-form-item>

                  <el-form-item label="尺寸" prop="chi_cun">
                    <el-input
                      placeholder="尺寸"
                      v-model="addUserForm.chi_cun"
                      maxlength="50"
                    ></el-input>
                  </el-form-item>
                  <el-form-item label="重量" prop="weight" class="dbasicList">
                    <el-input-number
                      v-model="addUserForm.weight"
                      controls-position="right"
                      :min="0"
                    ></el-input-number>
                  </el-form-item>
                  ...
                  <el-form-item label="物品图片" class="dRemarkList">
                    <div class="uploadFileList">
                      <div class="ufSfz">
                        <div class="ufsTop">
                          <div @click="addFilesClick()" class="ufstext">
                            添加图片
                          </div>
                        </div>
                        <div class="dingFilesClass">
                          <div
                            v-for="(item, index) in addUserForm.image"
                            :key="index"
                          >
                            <div>
                              <div class="fileIcon">
              ...
              <el-tab-pane label="价格信息" name="money">
                <div class="dBasicInfo">
                  <div class="addCaigou">
                    <p>采购价格</p>
                  </div>
                  ...
                  <el-form-item label="税率(%)" prop="output_tax_rate">
                    <el-input-number
                      v-model="addUserForm.output_tax_rate"
                      placeholder="请输入"
                      controls-position="right"
                      @change="cglChange"
                      :min="1"
                  ...
                  <el-form-item label="不含税单价(元)" prop="no_tax_price">
                    <el-input
                      v-model="addUserForm.no_tax_price"
                  ...
                  >
                    <el-input-number
                      v-model="addUserForm.tax_pur_price"
                      placeholder="请输入"
                      controls-position="right"
                      @change="inChange"
                      :min="0"
                  ...
                  <el-form-item label="税率(%)" prop="input_tax_rate">
                    <el-input-number
                      v-model="addUserForm.input_tax_rate"
                      placeholder="请输入"
                      controls-position="right"
                      @change="inlChange"
                      :min="1"
                  ...
                  <el-form-item
                    label="不含税单价(元)"
                    prop="notax_pur_price"
                    class="dbasicList"
                  >
                    <el-input
                      v-model="addUserForm.notax_pur_price"
                      :readonly="true"
                      placeholder="根据含税单价和税率自动计算"
                    ></el-input>
                  </el-form-item>
...
export default {
  ...
  methods: {
    ...
    derive() {
      let that = this;
      that.$axios
        .post("/projecttwo/createMaterialModel", {})
        .then((res) => {
          if (res.data.code == 1) {
            dd.ready(function () {
    ...
    handleNewAddClick(a) {
      this.addUserForm.type_name = a.name;
      this.addUserForm.type = a.id;
    ...
    editCancel(formName) {
      ...
      this.$nextTick(() => {
        this.$refs[formName].resetFields();
        this.addUserForm.type_name = "";
        this.addUserForm.extend_two = "";
    ...
    editInfo(formName) {
      ...
      _this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          console.log(newData.type, "newData.typenewData.type");
          delete newData.type_name;
          delete newData.quantity_sq;
          delete newData.quantity_zong;
          delete newData.quantity_rk;
          if (newData.type) {
            if (_this.viewOwnType == 1) {
              _this.$axios
                .post("/project/materialGoodsAdd", newData)
                .then((res) => {
                  if (res.data.code == 1) {
                    _this.updateTemp();
                    _this.getList();
                    ...
                    _this.$refs[formName].resetFields();
                    _this.addUserForm.type_name = "";
                    _this.addUserForm.type = "";
                    _this.addUserForm.extend_two = "";
                    _this.$message({
                      message: res.data.msg,
                      type: "success",
                      duration: 1500,
              ...
              _this.$axios
                .post("/project/materialGoodsEdit", newData)
                .then((res) => {
                  if (res.data.code == 1) {
                    _this.updateTemp();
                    _this.getList();
