          ...
          <el-form :inline="true" :model="formInline" class="demo-form-inline">
            <div class="hlBottom">
              ...
              <el-form-item label="收入类型:">
                <el-select v-model="formInline.income_type" clearable>
                  <el-option
                    value="软件开发定制收入"
                    label="软件开发定制收入"
                  />
                  <el-option
                    ...
                    label="网上软件下单收入"
                  />
                  <el-option value="劳务实名制收入" label="劳务实名制收入" />
                  <el-option value="智慧工地收入" label="智慧工地收入" />
                  <el-option value="监控收入" label="监控收入" />
                  <el-option value="其他收入" label="其他收入" />
                </el-select>
              </el-form-item>
              <el-form-item>
