    ...
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="fee_reimbursement"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    getList(ntype) {
      this.$axios
        .post("/project/feeReimbursementList", {
    ...
    deleteList() {
      if (this.multSelectData.length > 0) {
        this.$confirm("此操作将永久删除该审批单, 是否继续?", "提示", {
          ...
          .then(() => {
            this.$axios
              .post("/project/feeReimbursementDel", {
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post("/project/feeReimbursementload", {
