          ...
          <el-form :inline="true" :model="formInline" class="demo-form-inline">
            <div class="hlBottom">
              ...
              <el-form-item label="开票状态:">
                <el-select
                  v-model="formInline.wait_fp"
                  clearable
                  filterable
                  placeholder="请选择开票状态"
                >
                  <el-option label="已开发票" value="1"></el-option>
                  <el-option label="待收发票" value="2"></el-option>
                  <el-option label="无需开票" value="3"></el-option>
                </el-select>
              </el-form-item>
              <el-form-item>
...
export default {
  ...
  methods: {
    ...
    getList(ntype) {
      this.$axios
        .post("/project/hardPurApplyList", {
          page: this.currentPage,
          number: this.pagesize,
          shenpi: this.formInline.status,
          wait_fp: this.formInline.wait_fp,
        })
        .then((res) => {
          if (res.data.code == 1) {
            if (ntype == 1) {
