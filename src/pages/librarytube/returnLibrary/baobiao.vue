/*
 * @Author: NorthWind 
 * @Date: 2021-01-20 08:53:25 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-04-28 18:11:48
 */
<template>
              ...
              <div class="sum_footer xiaoji" ref="sum_xiaoji">
                ...
                <!-- <div class="sum_footer_unit over_sum_text">
                                <el-tooltip
                                    ...
                                    placement="top"
                                >
                                    <div style="text-align: left">{{ dxiaoji }}</div>
                                </el-tooltip>
                            </div> -->
                <div class="sum_footer_unit over_sum_text">
                  <el-tooltip
              ...
              <div class="sum_footer" ref="sum_heji">
                ...
                <!-- <div class="sum_footer_unit over_sum_text">
                                <el-tooltip
                                    ...
                                    placement="top"
                                >
                                    <div  style="text-align: left">{{ dheji }}</div>
                                </el-tooltip>
                            </div> -->
                <div class="sum_footer_unit over_sum_text">
                  <el-tooltip
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.$axios
        .post("/projectone/materialReturnReport", {
        ...
        .then((res) => {
          if (res.data.code == 1) {
            ...
            this.dxiaoji = res.data.price_subtotal;
            this.dheji = res.data.price_total;
            this.cxiaoji = res.data.tk_number_subtotal;
            this.cheji = res.data.tk_number_total;
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post("/projectone/materialReturnDownload", {
