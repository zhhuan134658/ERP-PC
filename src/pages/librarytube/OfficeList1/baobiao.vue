              ...
              <div class="sum_footer xiaoji" ref="sum_xiaoji">
                ...
                <div class="sum_footer_unit over_sum_text">
                  <el-tooltip
                    class="item"
                    effect="dark"
                    :content="notax_price_subtotal"
                    placement="top"
                  >
                    <div style="text-align: left">
                      {{ notax_price_subtotal }}
                    </div>
                  </el-tooltip>
                </div>
                <div class="sum_footer_unit over_sum_text">
...
export default {
  name: "materialSettleReport",
  components: { commonSearch },

  data() {
    return {
      activeindex: 0,
      toptitleList: [{ name: "审批列表" }, { name: "报表" }],
      //搜索条件
      formcommonList: [
        {
          labelName: "结算主题",
  ...
  methods: {
    ...
    getList() {
      ...
      this.$axios
        .post("/projectone/materialSettlementReport", {
        ...
        .then((res) => {
          if (res.data.code == 1) {
            ...
            this.nsdxiaoji = res.data.tax_price_subtotal;
            this.nsdheji = res.data.tax_price_total;
            ...
            this.notax_price_total = res.data.notax_price_total;
            this.notax_price_subtotal = res.data.notax_price_subtotal;
            this.$nextTick(() => {
              setTimeout(() => {
                this.adjustWidth();
              }, 500);
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post("/projectone/materialSettlementDownload", {
