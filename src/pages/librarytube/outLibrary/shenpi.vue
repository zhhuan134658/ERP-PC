    ...
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          printTableName="material_delivery"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    getList(ntype) {
      this.$axios
        .post("/project/materialDeliveryList", {
          ...
          out_person: this.formInline.out_person,
          project_name: this.formInline.project_name,
          use_person: this.formInline.use_person,
    ...
    backList() {
      this.$axios
        .post("/project/materialDeliveryReduction")
        .then((res) => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post("/project/materialDeliveryDownload", {
