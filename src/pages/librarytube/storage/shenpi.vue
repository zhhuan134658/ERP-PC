/* * @Author: NorthWind * @Date: 2020-12-08 14:07:42 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 10:09:41 */
<template>
    ...
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          printTableName="material_warehousing"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post("/project/materialWarehousing")
        .then((res) => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    deleteList() {
      //   if (
      //     this.newdata &&
      //     this.$store.state.cid !== 'dingdd959e3808ad2bed24f2f5cc6abecb85'
      //   ) {
      //     return this.$message({
      //       message: '已同意的审批不能删除',
      //       type: 'warning',
    ...
    backList() {
      this.$axios
        .post("/project/materialWarehousingReduction")
        .then((res) => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post("/project/materialWarehousingDownload", {
