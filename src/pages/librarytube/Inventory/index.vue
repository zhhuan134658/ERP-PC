    ...
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          printTableName="material_inventory"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post('/project/materialInventory')
        .then(res => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    getList(ntype) {
      this.$axios
        .post('/project/materialInventoryList', {
          ...
          inventory_person: this.formInline.inventory_person,
    ...
    backList() {
      this.$axios
        .post('/project/materialInventoryReduction')
        .then(res => {
          if (res.data.code == 1) {
            this.getList();
            this.$message({
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post('/project/materialInventoryDownload', {
