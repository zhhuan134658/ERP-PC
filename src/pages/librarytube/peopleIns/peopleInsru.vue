...
<el-dropdown @command="handleCommand"  trigger="click" size="medium" type="primary" split-button style="margin-left:10px;">
    <span class="el-dropdown-link">
    导入/导出
  </span>
  <el-dropdown-menu slot="dropdown">
    <el-dropdown-item command="b">批量导入入库</el-dropdown-item>
          ...
          <div class="basicCreate">
            ...
            >
              ...
              >
                ...
                <el-table-column prop="name" label="采购单号" align="left">
                </el-table-column>
                   <el-table-column prop="name" label="资产流水号" align="left">
                </el-table-column>
                   ...
                   <el-table-column prop="name" label="金额(元)" align="left">
                </el-table-column>
                   <el-table-column prop="name" label="所在位置" align="left">
                </el-table-column>
                   <el-table-column prop="name" label="购置方式" align="left">
                </el-table-column>
                   <el-table-column prop="name" label="计量单位" align="left">
                </el-table-column>
                   <el-table-column prop="name" label="备注" align="left">
                </el-table-column>
                   <el-table-column prop="name" label="供应商" align="left">
                </el-table-column>
                   <el-table-column prop="name" label="联系人" align="left">
                </el-table-column>
                   <el-table-column prop="name" label="联系方式" align="left">
                </el-table-column>
      ...
      >
        <div class="phdMain" style="padding:0 15px;">
          ...
          <div style="border-bottom:1px solid #D8E0E6;margin-bottom:10px;">
              <div style="border-bottom:1px solid #32CACB;width:61px;padding-bottom:5px;">模板信息</div>
          </div>
          ...
          <!-- 基础信息 -->
                       <div style="border-bottom:1px solid #D8E0E6;margin-bottom:10px;">
              <div style="border-bottom:1px solid #32CACB;width:61px;padding-bottom:5px;">基础信息</div>
          </div>
                <div class="dBasicInfo" style="flex-wrap:wrap;justify-content: space-between;">
                  <el-form-item label="资产名称：" prop="" class="dRemarkList" style="width:30%;">
                    <el-input
                  ...
                  <el-form-item label="资产分类：" class="dbasicList upOrg" style="width:30%;margin:0;">
                   ...
                   <el-form-item label="管理员：" prop="" class="dRemarkList" style="width:30%;">
                   ...
                   <el-form-item label="品牌：" prop="" class="dRemarkList" style="width:30%;">
                    <el-input
                      v-model="addUserForm.sitenumber"
                      placeholder="请输入品牌"
                      maxlength="50"
                  ...
                  <el-form-item label="型号：" prop="" class="dRemarkList" style="width:30%;">
                    <el-input
                      v-model="addUserForm.sitenumber"
                      placeholder="请输入型号"
                      maxlength="50"
                   ...
                   <el-form-item label="所属/承租公司:" prop=""  class="dRemarkList" style="width:30%;">
                      ...
                      style="width:165px;"
                       ...
                       <el-form-item label="使用公司：" prop="" class="dRemarkList" style="width:30%;">
                      ...
                      style="width:165px;"
                       ...
                       <el-form-item label="使用状态：" prop="" class="dRemarkList" style="width:30%;">
                      ...
                      style="width:165px;"
                       ...
                       <el-form-item label="所在位置：" prop="" class="dRemarkList" style="width:30%;">
                      <el-select v-model="value" placeholder="请选择所在位置" style="margin-left:;">
                        <el-option
                        label="item.label"
                      style="width:165px;"
                        ...
                        value="item.value">
                          ...
                          <el-form-item label="订单号：" prop="" class="dRemarkList" style="width:30%;">
                    <el-input
                      v-model="addUserForm.sitenumber"
                      placeholder="请输入订单号"
                      maxlength="50"
                    ...
                    ></el-input>
                     ...
                     <el-form-item label="购置方式：" prop="" class="dRemarkList" style="width:30%;">
                    ...
                    <el-form-item label="预计使用期限：" prop="" class="dRemarkList" style="width:30%;">
                                                    <el-input
                                        v-model="addUserForm.sitenumber"
                    ...
                    <el-form-item label="金额：" prop="" class="dRemarkList" style="width:30%;">
                    <el-input
                      v-model="addUserForm.sitenumber"
                      placeholder="请输入金额"
                      maxlength="50"
                ...
                <el-form-item label="计量单位：" prop="" class="dRemarkList" style="width:30%;">
                    <el-input
                      v-model="addUserForm.sitenumber"
                      placeholder="请输入计量单位"
                      maxlength="50"
                    ...
                    <el-form-item class="searchTime" label="购置/起购时间:" style="width:30%;">
                <el-date-picker
        ...
        <el-form-item label="备注：" prop="remarks" style="width:65%;">
            ...
            <imgupload
                ...
                ></imgupload>
                                     ...
                                     <!-- 维保信息 -->
          <div style="border-bottom:1px solid #D8E0E6;margin-bottom:10px;">
              <div style="border-bottom:1px solid #32CACB;width:61px;padding-bottom:5px;">维保信息</div>
          </div>

<div class="dBasicInfo" style="flex-wrap:wrap;justify-content: space-between;">
   <el-form-item label="供应商：" prop="" class="dRemarkList" style="width:30%;">
                    <el-input
                      v-model="addUserForm.sitenumber"
                      placeholder="请输入供应商"
                      maxlength="50"
                    ...
                    ></el-input>
                     ...
                     <el-form-item label="联系人：" prop="" class="dRemarkList" style="width:30%;">
                    <el-input
                      v-model="addUserForm.sitenumber"
                      placeholder="请输入联系人"
                      maxlength="50"
                    ...
                    ></el-input>
                     ...
                     <el-form-item label="联系方式：" prop="" class="dRemarkList" style="width:30%;">
                    <el-input
                      v-model="addUserForm.sitenumber"
                      placeholder="请输入联系方式"
                      maxlength="50"
            ...
            <el-form-item label="维保说明：" prop="remarks" style="width:65%;">
              <el-input
                type="textarea"
                v-model="basicAddForm.remarks"
                maxlength="240"
              ...
              ></el-input>
                 ...
                 <el-form-item label="维保到期时间：" prop="remarks" style="width:30%;">
              <el-date-picker
              :picker-options="pickerStart"
              v-model="basicAddForm.remarks"
              type="date"
