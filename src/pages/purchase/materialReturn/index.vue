...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post("/projecttwo/materialReturnOrder")
        .then((res) => {
          if (res.data.code == 1) {
            let newUrl =
    ...
    getList(ntype) {
      this.$axios
        .post("/projecttwo/materialReturnOrderList", {
    ...
    deleteList() {
      ...
      if (this.multSelectData.length > 0) {
        this.$confirm("此操作将永久删除该文件, 是否继续?", "提示", {
          ...
          .then(() => {
            this.$axios
              .post("/projecttwo/materialReturnOrderDel", {
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post("/projecttwo/materialReturnOrderDownload", {
