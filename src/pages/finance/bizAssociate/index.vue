    ...
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="business_cooperation"
          :hasUpload="false"
        ></commonTable>
        <div class="page">
          <el-pagination
...
export default {
  ...
  methods: {
    ...
    newAdd() {
      const _this = this;
      _this.$axios
        .post("/project/businessCooperation")
        .then(res => {
          if (res.data.code === 1) {
            let newUrl =
    ...
    getList(ntype) {
      this.$axios
        .post("/project/businessCooperationList", {
    ...
    deleteList() {
      if (this.multSelectData.length > 0) {
        this.$confirm("此操作将永久删除该审批单, 是否继续?", "提示", {
          ...
          .then(() => {
            this.$axios
              .post("/project/businessCooperationDel", {
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post("/project/businessCooperationDownload", {
