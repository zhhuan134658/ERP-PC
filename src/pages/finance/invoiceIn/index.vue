/* * @Author: NorthWind * @Date: 2020-12-12 13:50:37 * @Last Modified by:
NorthWind * @Last Modified time: 2022-01-13 14:01:59 */
<template>
  <div id="invoiceIn">
    <!-- 收票列表 -->
    <div class="main">
      ...
      <div class="mainContent">
        ...
        <commonTable
          ...
          :isFooter="isFooter"
          @listenChild="getMult"
          printTableName="ticket_register"
        ></commonTable>
        <div class="page">
          <el-pagination
  ...
  data() {
    return {
      ...
      formcommonList: [
        ...
        {
          labelName: "收款单位",
          labelData: "ticket_unit",
        },
        {
          labelName: "付款单位",
          labelData: "invoice_unit",
        },
        {
          labelName: "审批状态",
          labelData: "status",
  ...
  methods: {
    ...
    getList(ntype) {
      this.$axios
        .post("/project/ticketRegisterList", {
          ...
          filler: this.formInline.filler,
          shenpi: this.formInline.status,
          project_name: this.formInline.project_name,
          invoice_unit: this.formInline.invoice_unit,
          ticket_unit: this.formInline.ticket_unit,
    ...
    exportList() {
      ...
      if (_this.multSelectData.length > 0) {
        _this.$axios
          .post("/project/ticketRegisterDownload", {
