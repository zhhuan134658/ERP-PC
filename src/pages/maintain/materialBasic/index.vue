      ...
      <div class="content">
        <div class="header">
          <div class="headerContent">
            ...
            >
              <div class="hlBottom">
                <el-form-item label="分类名称编号:">
                  <el-input
                    v-model="addUserForm.name2"
                    clearable
                    placeholder="请输入分类名称编号"
          ...
          <div class="basicCreate">
            ...
            >
              ...
              >
                ...
                <el-table-column prop="pptype" label="上级分类" align="left">
                </el-table-column>
                <el-table-column
                  prop="expectancy"
                  label="预计使用期限(月)"
                ...
                <el-table-column prop="measuring" label="计量单位" align="left">
                </el-table-column>
      ...
      >
        <div class="phdMain">
          ...
          >
            ...
            >
              <el-tab-pane :label="newDialogTitle + '分类'" name="basic">
                <div class="dBasicInfo">
                  ...
                  >
                    <el-input
                      v-model="addUserForm.astypenumber"
                      placeholder="请输入分类编号"
                      maxlength="50"
                    ></el-input>
                  </el-form-item>
                  ...
                  <el-form-item label="上级分类：" class="dbasicList upOrg">
              ...
              <el-tab-pane label="添加资产扩展信息" name="money">
                <div class="dBasicInfo">
                  <el-form
                    @submit.native.prevent
                    :model="info"
                  ...
                  >
                    <div class="dBasicInfo">
                      ...
                      >
                        <el-radio-group v-model="info.extendtype">
                          <el-radio label="单行文本" disabled
                            >单行文本</el-radio
                          >
                          <el-radio label="数值" disabled>数值</el-radio>
                          <el-radio label="下拉单选" disabled
                            >下拉单选</el-radio
                          >
                        </el-radio-group>
                      </el-form-item>
                ...
                <el-button type="primary" @click="saveTabs" size="small"
                  >保存</el-button
                >
              </el-tab-pane>
            </el-tabs>
...
export default {
  ...
  methods: {
    ...
    selectAddCorp() {
      ...
      this.newAddView1 = !this.newAddView1;
    },
    handleNewAddClick1(row, checkedData) {
      let arr = [];
    ...
    handleClickList(data) {
      ...
      this.addUserForm.pptype = data.id;
    ...
    saveTabs() {
      ...
      if (this.info.name == "") {
        ...
        return;
      } else if (this.info.extendcontent == []) {
        this.$message({
          message: "请选择应用范围",
          type: "",
          duration: 1500,
    ...
    getList() {
      this.$axios
        .post("/erp_check/assettypelist", {
          corp_id: this.$store.state.cid,
          id: this.addUserForm.id,
          name: this.addUserForm.name1 || this.addUserForm.name,
        })
        .then((res) => {
          if (res.data.code == 1) {
            this.total = res.data.count;
    ...
    editPeopleInfo(row, column) {
      ...
      if (column.label != "操作") {
        ...
        _this.$nextTick(() => {
          ...
          _this.$axios
            .post("/erp_check/assetcontent", {
              id: row.id,
            })
            .then((res) => {
              if (res.data.code == 1) {
                _this.addUserForm = res.data.content;
                _this.addUserForm.type_name = res.data.content.ppname;
                console.log(
                  _this.addUserForm,
    ...
    editCancel(formName) {
      ...
      this.$nextTick(() => {
        ...
        this.addUserForm.type_name = "无上级(一级)";
      ...
      _this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          if (_this.viewOwnType == 1) {
            ...
            console.log(this.addUserForm, this.info);
            _this.$axios
              .post("/erp_check/assetaddtype", newData)
              .then((res) => {
                if (res.data.code == 1) {
                  _this.updateTemp();
                  _this.getList();
                  ...
                  _this.$refs[formName].resetFields();
                  _this.addUserForm.type_name = "无上级(一级)";
            ...
            _this.$axios
              .post("/erp_check/assetupdatetype", newData)
              .then((res) => {
                if (res.data.code == 1) {
                  _this.updateTemp();
                  _this.getList();
    ...
    deleteList(row) {
      this.$confirm("此操作将永久删除该文件, 是否继续?", "提示", {
        ...
        .then(() => {
          this.$axios
            .post("/erp_check/assetdeletetype", {
              id: row.id,
            })
            .then((res) => {
              if (res.data.code == 1) {
...
#materialBasic .phDialog .el-dialog__body .phdMain {
  height: 100%;
}
.headerBtn {
  display: flex;
