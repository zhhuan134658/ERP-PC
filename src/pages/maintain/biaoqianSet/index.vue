          ...
          <el-col :span="24">
            ...
            <div class="centerItem">
              ...
              <div style="width: 70%" class="biaoqian">
                <div class="moban">
                  <div
                    style="border-bottom: 1px dashed #999; padding-bottom: 5px"
                  >
                    <el-radio
                      v-model="info.name"
                      label="模板1"
            ...
            <div class="centerItem" v-if="info.name == '模板1'">
              ...
              <div style="width: 70%">
                <div>
                  <el-button type="primary" @click="addZ">添加字段</el-button
                  ><span style="margin-left: 25px">注: 三个字段为最佳效果</span>
                </div>
                ...
                <div style="margin-top: 20px" class="xuanZ">
                  ...
                  >
                    ...
                    {{ item }}
                    <span style="font-size: 16px" @click="close(index)">x</span>
                  </span>
              ...
              <div style="width: 70%" class="biaoqian">
                <div class="moban" style="padding: 0">
                  <div style="width: 100%; height: 100%">
                    ...
                    />
                    <div class="addLogo">
                      <imgupload v-on:listenToChildEvent="show"></imgupload>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div>
                    ...
                    ><span>1.选择的标签模板中含有logo,则支持企业自定义</span>
                  </div>
            ...
            <div class="centerItem">
              ...
              <div style="width: 70%">
                ...
                <el-radio v-model="info.papertape" label="A4纸">A4纸</el-radio>
              </div>
            </div>
