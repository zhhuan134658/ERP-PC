        ...
        <div class="phdMain" style="height: inherit">
          ...
          >
            <div class="dBasicInfo">
              ...
              <el-form-item
                label="折旧方式："
                prop="deprecitiontype"
                class="dRemarkList"
              >
                <el-select v-model="info.deprecitiontype" placeholder="请选择">
              ...
              <el-form-item
                ...
                class="dRemarkList"
              >
                <el-select v-model="info.deprecitiontime" placeholder="请选择">
                  <el-option label="购置/起租日当月" value="购置/起租日当月">
                  </el-option>
                  <el-option label="购置/起租日次月" value="购置/起租日次月">
                  </el-option>
                </el-select>
              </el-form-item>
              ...
              <el-form-item
                label="预计残值率："
                prop="deprecitionnumber"
                class="dRemarkList"
              >
                <el-input
                  v-model="info.deprecitionnumber"
                  placeholder="请输入预计残值率"
                  maxlength="50"
                ></el-input>
              </el-form-item>
                ...
                <el-button @click="selectAddCorp" plain style="width: 100%">
                  <div style="display: flex; width: 100%">
                    ...
                    >
                      ...
                      >
                        {{ item }}
                        <span @click="closeNmae(index)">x</span>
                      </div>
                    </div>
                  ...
                  <div class="addNewMain">
                    <div class="addNewList">
                      <el-tree
                        ...
                        show-checkbox
                        node-key="id"
                        :default-checked-keys="info.deprecitioncontent"
...
export default {
  ...
  methods: {
    //使用分类单个删除
    closeNmae(row) {
      this.info.deprecitioncontentName.splice(row, 1);
      this.info.deprecitioncontent.splice(row, 1);
    },
    inputs() {
      console.log("1");
    },
    ...
    handleNewAddClick(row, checkedData) {
      ...
      this.info.deprecitioncontentName = arr;
      this.info.deprecitioncontent = arr1;
      console.log(
        this.info.deprecitioncontentName,
        this.info.deprecitioncontent
      );
    },
    handleNewClick(a) {
      console.log(a);
    ...
    getBasicList() {
      ...
      this.$axios
        .post("/erp_check/assetzhejiuxilatypelist", {
          corp_id: this.$store.state.cid,
        })
        .then((res) => {
          if (res.data.code == 1) {
    ...
    getList() {
      this.$axios
        .post("/erp_check/assetdeprecitionlist", {
          corp_id: this.$store.state.cid,
        })
        .then((res) => {
          if (res.data.code == 1) {
            this.zhekList = res.data.content;
    ...
    addPeopleClick1(row) {
      ...
      this.addUserForm.id = "";
      this.$axios
        .post("/erp_check/assetdeprecitioncontent", {
          id: row.id,
        })
        .then((res) => {
          if (res.data.code == 1) {
      ...
      _this.$refs[formName].validate((valid) => {
        if (valid) {
          if (_this.viewOwnType == 1) {
            _this.$axios
              .post("/erp_check/assetdeprecitionadd", _this.info)
              .then((res) => {
                if (res.data.code == 1) {
                  //   _this.updateTemp();
                  _this.getList();
            ...
            _this.$axios
              .post("/erp_check/assetdeprecitionupdate", _this.info)
              .then((res) => {
                if (res.data.code == 1) {
                  //   _this.updateTemp();
                  _this.getList();
